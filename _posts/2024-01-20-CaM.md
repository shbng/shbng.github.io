...
<div class="figure">
    <img src="\src\images\CaM\charts.jpg" alt="" class="mid">
...
<div class="figure">
    <img src="\src\images\CaM\transition2.jpg" alt="" class="mid">
</div>
...
<ul>
    ...
    <li>
        ...
        <div class="figure">
            <img src="\src\images\CaM\differential.jpg" alt="" class="mid">
        </div>
    ...
    <li>
        ...
        <div class="figure">
            <img src="\src\images\CaM\ChangeOfCoordinates.jpg" alt="" class="mid">
        </div>
...
<div class="figure">
    <img src="\src\images\CaM\velocity.png" alt="" class="mid">
</div>
...
<ul>
    ...
    <li> The Tangent bundle is $(TM,\pi,M)$ (or simply written TM) where
        ...
        <div class="figure">
            <img src="\src\images\CaM\Tbundle.png" alt="" class="mid">
...
<div class="figure">
    <img src="\src\images\CaM\Lift!.jpg" alt="" class="mid">
